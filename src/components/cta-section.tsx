...
export function CtaSection() {
  ...
  return (
    <section ref={ref} id="contacto" className="py-20 lg:py-32 bg-[#1a1614] text-[#faf8f5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2
            className={`font-serif text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 text-balance transition-all duration-500 ease-out delay-200 ${
          ...
          <p
            className={`text-[#faf8f5]/80 text-lg mb-10 max-w-2xl mx-auto text-pretty transition-all duration-500 ease-out delay-300 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          <p
            className={`mt-8 text-[#faf8f5]/60 text-sm transition-all duration-500 ease-out delay-500 ${
              isVisible ? "opacity-100" : "opacity-0"
            }`}
          >
